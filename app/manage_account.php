                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                            ...
                            <button id="my-button" type="button" tabindex="-1" class="btn btn-outline-primary btn-lg mb-0 rounded-0 border-0 px-1 pass_view"><i id="icon" class="material-icons">visibility_off</i></button>
                        </div>
                        <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                            ...
                            <button id="my-button1"  type="button" tabindex="-1" class="btn btn-outline-primary btn-lg mb-0 rounded-0 border-0 px-1 pass_view"><i id="icon1" class="material-icons">visibility_off</i></button>
                        </div>
                    </div>
                </div>
...
<script>
//added script for visibility of password
    $(function(){
...
//added script for visibility of confirm password
  $("#my-button1").click(function() {
    var x = $("#cpassword");
    if (x.attr("type") === "password") {
      x.attr("type", "text");
      $("#icon1").html("visibility");
    } else {
      x.attr("type", "password");
      $("#icon1").html("visibility_off");
    }
  });
